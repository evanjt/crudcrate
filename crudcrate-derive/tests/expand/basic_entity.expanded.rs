mod Model {
    ...
    impl crudcrate::CRUDResource for Todo {
        ...
        const RESOURCE_DESCRIPTION: &'static str = "This resource manages todos items";
    ...
    crudcrate::crud_handlers!(
        Todo, TodoUpdate, TodoCreate, TodoList, TodoResponse, TodoList, TodoResponse
    );
    impl Todo {
    ...
    impl From<Todo> for TodoList {
        fn from(model: Todo) -> Self {
            Self {
                id: model.id,
                title: model.title,
                completed: model.completed,
    ...
    pub type TodoScopedList = TodoList;
    pub type TodoScopedResponse = TodoResponse;
    impl crudcrate::ScopeFilterable for TodoList {}
    impl crudcrate::ScopeFilterable for Todo {}
    #[derive(
        Clone,
        Debug,
        PartialEq,
