mod Model {
    ...
    impl crudcrate::CRUDResource for Tag {
        type EntityType = Entity;
        type ColumnType = Column;
        type ActiveModelType = ActiveModel;
        type CreateModel = TagCreate;
        ...
        const RESOURCE_DESCRIPTION: &'static str = "This resource manages tags items";
        const FULLTEXT_LANGUAGE: &'static str = "english";
        fn sortable_columns() -> Vec<(&'static str, Self::ColumnType)> {
            vec![("name", Self::ColumnType::Name)]
        }
        fn filterable_columns() -> Vec<(&'static str, Self::ColumnType)> {
            vec![("name", Self::ColumnType::Name), ("color", Self::ColumnType::Color)]
        }
    ...
    pub type TagScopedList = TagList;
    pub type TagScopedResponse = TagResponse;
    impl crudcrate::ScopeFilterable for TagList {}
    impl crudcrate::ScopeFilterable for Tag {}
    #[derive(
        Clone,
        Debug,
        PartialEq,
