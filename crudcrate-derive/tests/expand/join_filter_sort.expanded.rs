mod vehicle__Model {
    ...
    impl crudcrate::CRUDResource for Vehicle {
        ...
        fn sortable_columns() -> Vec<(&'static str, Self::ColumnType)> {
            vec![("make", Self::ColumnType::Make), ("year", Self::ColumnType::Year)]
        }
    ...
    impl crudcrate::CRUDResource for Customer {
        ...
        fn joined_filterable_columns() -> Vec<crudcrate::JoinedColumnDef> {
            vec![
                ...
                "make", full_path : "vehicles.make", }, crudcrate::JoinedColumnDef {
                join_field : "vehicles", column_name : "year", full_path :
                "vehicles.year", }
            ]
        }
        fn joined_sortable_columns() -> Vec<crudcrate::JoinedColumnDef> {
            ...
            match join_field {
                "vehicles" => {
                    ...
                    if let Some(__child_col_ref) = __child_col_ref {
                        ...
                        for __key_column in Self::id_columns() {
                            __models = __models
                                .order_by(__key_column, direction.clone());
                        }
