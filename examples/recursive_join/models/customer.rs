...
// Note: These will be generated by the macro, so we don't need to import them here
...
pub struct Model {
    ...
    // Re-enabled join field for recursive joins with depth limit to prevent cycles
    #[sea_orm(ignore)]
